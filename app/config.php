...
if (file_exists(CMF_ROOT . "data/conf/config.php")) {
    ...
    $runtimeConfig = include CMF_ROOT . "app/adminyw/config.php";
} else {
    $runtimeConfig = [];
}
array_push($runtimeConfig,include APP_PATH.'ywtr/function.php');
...
$configs = [
    ...
    'cmf_default_theme'       => 'ywtr',
    'cmf_admin_theme_path'    => 'themes/',
    'cmf_admin_default_theme' => 'adminyw',
